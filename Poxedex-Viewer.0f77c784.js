...
//CASTOM IMPORTS
var _getPokeInfo = require("./getPokeInfo");
var _getPokeInfoDefault = parcelHelpers.interopDefault(_getPokeInfo);
...
appInput.addEventListener("input", (0, _lodashDebounceDefault.default)(searchPokeFunc, 500));
function searchPokeFunc(evt) {
    const pokeName = evt.target.value.trim();
    appCardSpace.innerHTML = "";
    (0, _getPokeInfoDefault.default)(pokeName).then((res)=>{
         ...
         <div class="app-card">
                <div class="card-text_info">
                    ...
                    <ul class="card-list_abilities">
                      ${abilitiesArray.map(({ ability, is_hidden })=>{
...
},{"../node_modules/@pnotify/core/dist/PNotify.js":"fay4s","../node_modules/@pnotify/mobile/dist/PNotifyMobile.js":"5RXYV","@pnotify/core/dist/BrightTheme.css":"grIyt","./getPokeInfo":"aL3qB","lodash.debounce":"irvaP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fay4s":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"grIyt":[function() {},{}],"aL3qB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>getPokeInfo);
function getPokeInfo(nameOfPokemon) {
    return fetch(`https://pokeapi.co/api/v2/pokemon/${nameOfPokemon.toLowerCase()}`).then((res)=>{
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire73a9", {})

//# sourceMappingURL=Poxedex-Viewer.0f77c784.js.map
